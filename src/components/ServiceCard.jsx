...
const ServiceCard = (props) => {
  ...
  return (
    <div onClick={clickhandler}  className='bg-white rounded-xl mb-7 ml-3 lg:w-[300px] lg:h-[400px] md:w-[230px] md:h-[300px] w-[190px] h-[250px] flex items-center pt-5 flex-col shadow-2xl'>
